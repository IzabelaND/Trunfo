...
var cartaRafa = {
  nome:"Bulbasauro",
  imagem: "https://i0.wp.com/i.ytimg.com/vi/N9DVZRs4jx0/hqdefault.jpg",
  atributos:{
    ataque:70,
    defesa:65,
    magia:85
...
function jogar() {
  ...
  if(cartaJogador.atributos[atributoSelecionado] > cartaMaquina.atributos[atributoSelecionado]){
    htmlResultado = '<p class="resultado-final">Você venceu à máquina! \n Parabens!</p>'
    pontosJogador++
  ...
  //document.getElementById("btnProximaRodada").disabled = false  //passou para a linha 184 - acima
...
//site indicado https://carbon.now.sh/